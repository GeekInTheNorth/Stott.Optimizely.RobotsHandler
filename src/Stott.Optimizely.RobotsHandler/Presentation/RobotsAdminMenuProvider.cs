...
public class RobotsAdminMenuProvider : IMenuProvider
{
    public IEnumerable<MenuItem> GetMenuItems()
    {
        ...
        yield return CreateMenuItem("Query Rules", "/global/cms/stott.optimizely.robotshandler/queryrules", "/stott.robotshandler/administration/#query-rules", SortIndex.Last + 5);
        yield return CreateMenuItem("API Tokens", "/global/cms/stott.optimizely.robotshandler/opaltools", "/stott.robotshandler/administration/#api-tokens", SortIndex.Last + 6);
    }
